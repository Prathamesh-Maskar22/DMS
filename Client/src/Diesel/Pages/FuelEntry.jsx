...
const FuelEntry = () => {
  ...
  useEffect(() => {
    if (form.is_new_trip) return;                    // Only in Past Trip mode
  ...
  // ==================== FETCH PAST TRIP (with clear logic) ====================
  const handleFetchPastTrip = async () => {
    ...
    try {
      ...
      if (response.ok && result.data) {
        ...
        // NO DATA → CLEAR FORM (keep only Customer, Vehicle, toggles & date)
        setForm(prev => ({
          ...prev,
          driver_id: '',
          from_city_id: '',
      ...
      console.error(err);
      toast.success('Network error while fetching past trip.');
    } finally {
  ...
  return (
    <div className="max-w-6xl mx-auto mt-4 bg rounded-2xl border border-gray-100 shadow-sm overflow-hidden mb-8">
      ...
      <form onSubmit={handleSubmit}>
        <div className="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-4 lg:col-span-2">
            ...
            {!form.is_new_trip && fetchingPast && (
              <div className="flex items-center gap-3 bg-amber-50 text-amber-700 px-4 py-3 rounded-2xl text-sm font-medium">
            ...
            {/* Cities, Invoice, Diesel, Loading Weight etc. - Rest of your form remains exactly the same */}
            {/* (Cities, Invoice Details, Diesel & KM, Loading Weight, Right Column, Extra Diesel, Cutting Diesel, Remarks, Footer) */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <select name="from_city_id" value={form.from_city_id} onChange={handleChange} className="w-full pl-10 pr-4 py-2.5 border border-gray-200 bg-white rounded-xl focus:ring-2 focus:ring-blue-500">
              ...
              <div>
                ...
                <div className="relative">
                  <MapPin size={18} className="absolute left-3 top-3 text-gray-400" />
                  <select name="to_city_id" value={form.to_city_id} onChange={handleChange} className="w-full pl-10 pr-4 py-2.5 border border-gray-200 bg-white rounded-xl focus:ring-2 focus:ring-blue-500">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                <div className="md:col-span-1">
                  ...
                  <div className="relative">
                    ...
                    <input name="invoice_number" type="text" value={form.invoice_number} onChange={handleChange} className="w-full pl-10 pr-3 py-2 border border-gray-200 bg-gray-50 rounded-xl focus:ring-2 focus:ring-blue-500" placeholder="INV-001" />
                  </div>
                </div>
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input name="invoice_time" type="time" value={form.invoice_time} onChange={handleChange} className="w-full pl-10 pr-3 py-2 border border-gray-200 bg-gray-50 rounded-xl focus:ring-2 focus:ring-blue-500" />
                  </div>
                </div>
                <div>
                  <label className="block text-xs font-bold text-gray-500 uppercase mb-1">Material</label>
                  <input name="material_type" type="text" value={form.material_type} onChange={handleChange} className="w-full px-3 py-2 border border-gray-200 bg-gray-50 rounded-xl focus:ring-2 focus:ring-blue-500" placeholder="e.g. Cement" />
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input name="diesel_qty" type="number" step="0.01" value={form.diesel_qty} onChange={handleChange} className="w-full pl-10 pr-4 py-2.5 border border-blue-200 bg-blue-50 rounded-xl focus:ring-2 focus:ring-blue-500 font-semibold text-blue-700" required />
                </div>
              </div>
              <div>
                <label className="block text-xs font-bold text-gray-500 uppercase mb-1">KM</label>
                <input name="km" type="number" value={form.km} onChange={handleChange} className="w-full px-4 py-2.5 border border-gray-200 bg-gray-50 rounded-xl focus:ring-2 focus:ring-blue-500" />
              </div>
            </div>
            ...
            <div>
              ...
              <input name="loading_weight" type="number" step="0.01" value={form.loading_weight} onChange={handleChange} className="w-full px-4 py-2.5 border border-gray-200 bg-gray-50 rounded-xl focus:ring-2 focus:ring-blue-500" placeholder="e.g. 25.50" />
            </div>
          </div>

          {/* RIGHT COLUMN - unchanged */}
          <div className="space-y-4">
            {/* Route, Pump, Financials, Extra Diesel, Cutting Diesel, Remarks */}
            <div>
              <label className="block text-xs font-bold text-gray-500 uppercase mb-1">Route</label>
              <select name="route_id" value={form.route_id} onChange={handleChange} className="w-full px-4 py-2.5 border border-gray-200 bg-gray-50 rounded-xl focus:ring-2 focus:ring-blue-500 bg-white">
            ...
            <div>
              ...
              <select name="pump_id" value={form.pump_id} onChange={handleChange} className="w-full px-4 py-2.5 border border-gray-200 bg-gray-50 rounded-xl focus:ring-2 focus:ring-blue-500 bg-white">
            ...
            <div className="border-t border-gray-100 pt-4">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input name="trip_advance_amount" type="number" value={form.trip_advance_amount} onChange={handleChange} className="w-full px-3 py-2 border border-gray-200 bg-gray-50 rounded-xl focus:ring-2 focus:ring-blue-500" />
                </div>
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    <label className="text-xs text-gray-600">Fooding</label>
                    <input name="fooding_amount" type="number" value={form.fooding_amount} onChange={handleChange} className="w-full px-3 py-2 border border-gray-200 bg-gray-50 rounded-xl focus:ring-2 focus:ring-blue-500" />
                  </div>
                  <div>
                    <label className="text-xs text-gray-600">L/U</label>
                    <input name="loading_unloading_amount" type="number" value={form.loading_unloading_amount} onChange={handleChange} className="w-full px-3 py-2 border border-gray-200 bg-gray-50 rounded-xl focus:ring-2 focus:ring-blue-500" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="border-t border-gray-100 pt-4">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input name="extra_diesel_qty" type="number" step="0.01" value={form.extra_diesel_qty} onChange={handleChange} className="w-full px-3 py-2 border border-orange-200 rounded-xl focus:ring-orange-500" />
                </div>

                {Number(form.extra_diesel_qty) > 0 && (
                  <div className="mt-3 space-y-2">
                    <select name="extra_diesel_remark_id" value={form.extra_diesel_remark_id} onChange={handleChange} className="w-full px-3 py-2 border border-gray-200 bg-gray-50 rounded-xl text-sm">
                      <option value="">Select Reason</option>
                      {masters.extraRemarks.map(r => <option key={r.id} value={r.id}>{r.remark_text}</option>)}
                    </select>

                    <select name="approved_by_id" value={form.approved_by_id} onChange={handleChange} className="w-full px-3 py-2 border border-gray-200 bg-gray-50 rounded-xl text-sm">
            ...
            <div className="border-t border-gray-100 pt-4">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input name="cut_diesel_qty" type="number" step="0.01" value={form.cut_diesel_qty} onChange={handleChange} className="w-full px-3 py-2 border border-red-200 rounded-xl focus:ring-red-500" />
                </div>
                <div>
            ...
            <div className="border-t border-gray-100 pt-4">
              ...
              <textarea name="remarks" value={form.remarks} onChange={handleChange} className="w-full px-3 py-2 border border-gray-200 bg-gray-50 rounded-xl h-20 text-sm resize-none" placeholder="Add notes..." />
            </div>
          </div>
        </div>
        ...
        <div className="p-6 border-t border-gray-100 bg-gray-50 flex justify-between items-center">
          ...
          <div className="flex gap-3">
            ...
            <button type="submit" disabled={loading} className="px-8 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium shadow-md flex items-center gap-2 disabled:opacity-50">
